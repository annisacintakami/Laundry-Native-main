...
$extraAccess = [
  ...
  1 => ['add-role-menu', 'tambah-report', 'tambah-service', 'tambah-level', 'tambah-customer','tambah-menu', 'tambah-user','tambah-tax'], // 1 = Admin
  2 => ['tambah-report']
...
<head>
  ...
  <title class="d-print-none">LaundryNow!</title>
