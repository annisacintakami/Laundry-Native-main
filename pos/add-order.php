...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/annisa.css">
...
<body>
      ...
      <div class="col-md-5 cart-section">
        ...
        <div class="cart-footer">
          <div class="total-section">
            ...
            <div class="d-flex justify-content-between mb-2">
              <span>Pay :</span>
              <input type="number" id="pay" class="form-control w-50" placeholder="Enter the amount" oninput="calculateChange()" style="background-color: #c9e3f8ff;">
            </div>
            <div class="d-flex justify-content-between mb-2">
              <span>Change :</span>
              <input type="number" id="change" class="form-control w-50" style="background-color: #f7e3e9ff;" readonly >
            </div>
          </div>
          <div class="row g-2">
            <div class="col-md-6">
  ...
  <script src="../assets/js/annisa.js"></script>
